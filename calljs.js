...
var makeCallBtn = document.getElementById('make-call');
var joinCallBtn = document.getElementById('join-call');

makeCallBtn.addEventListener('click', function () {
  const fname = window.prompt('enter your name');

  init(fname);
});

joinCallBtn.addEventListener('click', function () {
  const fname = window.prompt('enter friend name');
